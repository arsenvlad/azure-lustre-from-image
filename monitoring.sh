...
# ./monitoring.sh -n MGS -i 1 -d 4 -m 10.1.0.4 -l 10.1.0.4 -f scratch -g 10.1.0.5 -h 10.1.0.6
# ./monitoring.sh -n MDS -i 1 -d 4 -m 10.1.0.4 -l 10.1.0.5 -f scratch -g 10.1.0.5 -h 10.1.0.6
# ./monitoring.sh -n OSS -i 1 -d 4 -m 10.1.0.4 -l 10.1.0.6 -f scratch -g 10.1.0.5 -h 10.1.0.6
